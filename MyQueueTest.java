...
public class MyQueueTest {
	...
	public void testEnqueueStudent() {
		...
		try {
			...
			assertEquals(true, doubleQ.enqueue(one));
			assertEquals(4, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(two));
	...
	public void testToStringStudent() throws QueueOverflowException {
		...
		doubleQ.enqueue(two);
		assertEquals("1.02.03.02.0", doubleQ.toString());
		doubleQ.enqueue(one);
		assertEquals("1.02.03.02.01.0", doubleQ.toString());
	}
